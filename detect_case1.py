...
class Yolov3:
    def __init__(self, weights_path, cfg_path):
        self.weights = 'D:\DETECTION_VIDEO\yolov3.weights'  # loading weights
        self.cfg = 'D:\DETECTION_VIDEO\yolov3.cfg'  # loading cfg file
    ...
    def bounding_box(self, detections):
        ...
        for i in detections:
            for j in i:
                ...
                if confidence_ > Threshold and class_ == self.classes.index('person'):
