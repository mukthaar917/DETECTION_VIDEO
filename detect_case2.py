...
class Yolov3:
    def __init__(self, weights_path, cfg_path):
        self.weights = 'D:\DETECTION_VIDEO\yolov3.weights'
        self.cfg = 'D:\DETECTION_VIDEO\yolov3.cfg'
...
def parse_args():
    ...
    parser.add_argument('--video', type=str, default='traffic_signs.mp4', help='Path to input video file')
